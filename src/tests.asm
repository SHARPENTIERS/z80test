...
.bit_n_xyd_r flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
...
.set_n_xyd_r flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
...
.res_n_xyd_r flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
...
.cpdr       flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
            ...
            ; Input/Output.
            ; Port address 0xff of MZ-80K/700/800 is printer data

.in_a_n     flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            vec     0xdb,0xff,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0xbbcc,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x919e2255,all,0x05d2a241,docflags,0x919e2255,doc,0x05d2a241,ccf,0xc3f6460b,mptr,0x253c1992; Sampled from EmuZ-700, not actual machine.
            name    "IN A,(N)"

.in_r_c    flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
            vec     0xed,0x40,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0xbbff,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x38,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x91d81d55,all,0x82517015,docflags,0x46693426,doc,0xf4e46546,ccf,0x339ca556,mptr,0x8f28a661; Sampled from EmuZ-700, not actual machine.
            name    "IN R,(C)"

.in_c       flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
            vec     0xed,0x70,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0xbbff,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x27d9858a,all,0x0232e5ba,docflags,0xe94fde6e,doc,0xd88e9ddb,ccf,0xfceb28dd,mptr,0x61fe077d; Sampled from EmuZ-700, not actual machine.
            name    "IN (C)"

.ini        flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xa2,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            ...
            crcs    allflags,0x2d40a9e8,all,0x8e250e5d,docflags,0xdf14e043,doc,0xee2902e7,ccf,0x3a67cd73,mptr,0x84667387; Sampled from EmuZ-700, not actual machine.
            name    "INI"

.ind        flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xaa,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0xff00,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x45c2bf9a,all,0xd035f229,docflags,0xdf14e043,doc,0xd43e37cc,ccf,0x91949f4b,mptr,0x630733cb; Sampled from EmuZ-700, not actual machine.
            name    "IND"

.inir       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xb2,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x01ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0200,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xb066d78c,all,0xe08849ab,docflags,0x550e6d82,doc,0x5c294bb8,ccf,0x2c6e5999,mptr,0x45a820bd; Sampled from EmuZ-700, not actual machine.
            name    "INIR"

.indr       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xb2,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x01ff,de,0xddee,hl,mem+1 ,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0200,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xb066d78c,all,0xb8d69afb,docflags,0x550e6d82,doc,0x047798e8,ccf,0x2c6e5999,mptr,0x45a820bd; Sampled from EmuZ-700, not actual machine.
            name    "INDR"

.out_n_a    flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            vec     0xd3,0xff,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0xbbcc,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0xff,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
...
.out_c_r    flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            vec     0xed,0x41,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x38,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0xff,f,0xff,bc,0xff00,de,0xffff,hl,0xffff,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x2c0d4f69,all,0x1a286056,docflags,0x2c0d4f69,doc,0x1a286056,ccf,0x36547c3c,mptr,0x42389d5f; Sampled from EmuZ-700, not actual machine.
            name    "OUT (C),R"

.out_c_0    flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            vec     0xed,0x71,stop,0x00,mem,0x1234,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,0x4411,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0xff,f,0xff,bc,0xff00,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xa6eacb74,all,0xe7f2f969,docflags,0xa6eacb74,doc,0xe7f2f969,ccf,0x226855e0,mptr,0x4831847c; Sampled from EmuZ-700, not actual machine.
            name    "OUT (C),0"

.outi       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xa3,stop,0x00,mem,0x0000,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            ...
            crcs    allflags,0xf0c58202,all,0xa15e43f1,docflags,0x27b692d1,doc,0x929f8670,ccf,0x5e1d09c8,mptr,0x8c90b626; Sampled from EmuZ-700, not actual machine.
            name    "OUTI"

.outd       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xab,stop,0x00,mem,0x0000,a,0xaa,f,0xff,bc,0x00ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            vec     0x00,0x00,0x00,0x00,mem,0x0087,a,0x00,f,0x00,bc,0x8700,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0078,a,0x00,f,0xff,bc,0x7800,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xfa1ad03e,all,0x0bd1666c,docflags,0x27b692d1,doc,0x9e722268,ccf,0xe7aa6896,mptr,0xa8b663f9; Sampled from EmuZ-700, not actual machine.
            name    "OUTD"

.otir       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xb3,stop,0x00,mem,0x0000,a,0xaa,f,0xff,bc,0x01ff,de,0xddee,hl,mem   ,ix,0xdd88,iy,0xfd77,sp,0xc000
            ...
            crcs    allflags,0x1a975ed3,all,0xcdcbf122,docflags,0x369c862e,doc,0x59e9eb84,ccf,0x275e3430,mptr,0x9ff6297f; Sampled from EmuZ-700, not actual machine.
            name    "OTIR"

.otdr       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            vec     0xed,0xbb,stop,0x00,mem,0x0000,a,0xaa,f,0xff,bc,0x01ff,de,0xddee,hl,mem+1 ,ix,0xdd88,iy,0xfd77,sp,0xc000
            ...
            crcs    allflags,0xb611c16f,all,0xec245d00,docflags,0x369c862e,doc,0xd81084ad,ccf,0xde272f70,mptr,0xd7cf070f; Sampled from EmuZ-700, not actual machine.
            name    "OTDR"
