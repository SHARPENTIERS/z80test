...
.in_a_n     flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            ...
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x919e2255,all,0x58bc9667,docflags,0x919e2255,doc,0x05d2a241,ccf,0x31d82768,mptr,0x253c1992; Sampled from EmuZ-700, MZ-1500
            name    "IN A,(N)"
...
.in_r_c    flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
            ...
            vec     0x00,0x38,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x91d81d55,all,0xf5996763,docflags,0x46693426,doc,0xf4e46546,ccf,0x2a116d32,mptr,0x587e9d23; Sampled from EmuZ-700, MZ-1500
            name    "IN R,(C)"
...
.in_c       flags   s,1,z,1,f5,0,hc,1,f3,0,pv,1,n,1,c,1
            ...
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x27d9858a,all,0x4f6c2bdf,docflags,0xe94fde6e,doc,0xd88e9ddb,ccf,0x97b7e0ef,mptr,0x253c1992; Sampled from EmuZ-700, MZ-1500
            name    "IN (C)"
...
.ini        flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            crcs    allflags,0x2d40a9e8,all,0xf38f5e62,docflags,0xdf14e043,doc,0xee2902e7,ccf,0x62fb1b93,mptr,0x84667387; Sampled from EmuZ-700, MZ-1500
            name    "INI"
...
.ind        flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0xff00,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0000,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0x45c2bf9a,all,0xc9986b49,docflags,0xdf14e043,doc,0xd43e37cc,ccf,0x62fb1b93,mptr,0xc1c124c8; Sampled from EmuZ-700, MZ-1500
            name    "IND"
...
.inir       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            crcs    allflags,0xb066d78c,all,0x7438a6ff,docflags,0x550e6d82,doc,0x5c294bb8,ccf,0xfe717a2d,mptr,0x45a820bd; Sampled from EmuZ-700, MZ-1500
            name    "INIR"
...
.indr       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0x00,bc,0x0000,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0000,a,0x00,f,0xff,bc,0x0200,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xb066d78c,all,0x3d3f7bb6,docflags,0x550e6d82,doc,0x047798e8,ccf,0xfe717a2d,mptr,0x45a820bd; Sampled from EmuZ-700, MZ-1500
            name    "INDR"
...
.out_c_r    flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            ...
            crcs    allflags,0x2c0d4f69,all,0x1a286056,docflags,0x2c0d4f69,doc,0x1a286056,ccf,0x36547c3c,mptr,0xbf071c7d; Sampled from EmuZ-700, MZ-1500
            name    "OUT (C),R"
...
.out_c_0    flags   s,1,z,1,f5,1,hc,1,f3,1,pv,1,n,1,c,1
            ...
            crcs    allflags,0xa6eacb74,all,0xe7f2f969,docflags,0xa6eacb74,doc,0xe7f2f969,ccf,0x226855e0,mptr,0xb7b56c76; Sampled from EmuZ-700, MZ-1500
            name    "OUT (C),0"
...
.outi       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            crcs    allflags,0xf0c58202,all,0xa15e43f1,docflags,0x27b692d1,doc,0x929f8670,ccf,0xba903ab0,mptr,0x8c90b626; Sampled from EmuZ-700, MZ-1500
            name    "OUTI"
...
.outd       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            vec     0x00,0x00,0x00,0x00,mem,0x0087,a,0x00,f,0x00,bc,0x8700,de,0x0000,hl,0x0000,ix,0x0000,iy,0x0000,sp,0x0000
            vec     0x00,0x00,0x00,0x00,mem,0x0078,a,0x00,f,0xff,bc,0x7800,de,0x0000,hl,0x0001,ix,0x0000,iy,0x0000,sp,0x0000
            crcs    allflags,0xfa1ad03e,all,0x0bd1666c,docflags,0x27b692d1,doc,0x9e722268,ccf,0x03275bee,mptr,0xa8b663f9; Sampled from EmuZ-700, MZ-1500
            name    "OUTD"
...
.otir       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            crcs    allflags,0x1a975ed3,all,0xcdcbf122,docflags,0x369c862e,doc,0x59e9eb84,ccf,0x275e3430,mptr,0x9ff6297f; Sampled from EmuZ-700
            name    "OTIR"
...
.otdr       flags   s,0,z,1,f5,0,hc,0,f3,0,pv,0,n,0,c,0
            ...
            crcs    allflags,0xb611c16f,all,0xec245d00,docflags,0x369c862e,doc,0xd81084ad,ccf,0xde272f70,mptr,0xd7cf070f; Sampled from EmuZ-700
            name    "OTDR"
